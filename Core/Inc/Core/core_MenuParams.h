...
const struct MENU_PARAM params[] = {
		...
		"B16.MU/DU       ", "    ", 	1,      3,  	1, M_LIST|M_SADR(135),						//56
		"B17.RESERV      ", "    ", 	1,      3,  	1, M_SHOW|M_RMAX(1),             //M_LIST|M_SADR(135),						//57
		"B18.RESERV      ", "    ", 	1,      3,  	1, M_SHOW|M_RMAX(1),             //M_LIST|M_SADR(135),	
		...
		"B33.NO MOVE TIME", "S   ", 	3,    100,     20, M_EDIT|M_RMAX(2)|M_PREC(1),				        //72 100=10,0Я
		...
		"B40.бйкчв пец   ", "    ", 	0,      1,  	0, M_LIST|M_SADR(187),						//79
		"B41.бйк аег онк ", "    ", 	0,      1,  	0, M_LIST|M_SADR(187),						//80
		...
		"C5.NOM CURRENT  ", "A   ",     1,   1200,     63, M_FACT|M_RMAX(2)|M_PREC(1),				        //95
		...
		"я34.гнмю рнплнф ", "    ",-32000U,  32000,      0, M_FACT|M_RMAX(4),						//124						//124
		"я35.пюяяр лстрш ", "    ",     0,    100,      2, M_FACT|M_RMAX(2),						//125			//125
		"я36.южо гмюв    ", "    ", 	0,  65535,  	0, M_SHOW|M_RMAX(4),						//126
		"я37.жюо гюдюм   ", "    ", 	0,  65535,  	0, M_FACT|M_RMAX(4),						//127
		"   я38.пеб южо  ", "    ", 	0,  1,  	0, M_FACT|M_RMAX(4),						//128
		"   я39.пеб жюо  ", "    ", 	0,  1,  	0, M_FACT|M_RMAX(4),						//129
                "я40.южорнв1 4   ", "    ", 	0,  65535,   6719, M_FACT|M_RMAX(4),						//130
		"я41.южорнв2 4.5 ", "    ", 	0,  65535,   7315, M_FACT|M_RMAX(4),						//131
		"я42.южорнв3 5   ", "    ", 	0,  65535,   7914, M_FACT|M_RMAX(4),						//132
		"я43.южорнв4 5.5 ", "    ", 	0,  65535,   8512, M_FACT|M_RMAX(4),						//133
		"я44.южорнв5 6   ", "    ", 	0,  65535,   9110, M_FACT|M_RMAX(4),						//134
		"я45.южорнв6 6.5 ", "    ", 	0,  65535,   9706, M_FACT|M_RMAX(4),						//135
                "я46.южорнв7 7   ", "    ", 	0,  65535,  10305, M_FACT|M_RMAX(4),						//136
		"я47.южорнв8 7.5 ", "    ", 	0,  65535,  10902, M_FACT|M_RMAX(4),						//137
		"я48.южорнв9 8   ", "    ", 	0,  65535,  11497, M_FACT|M_RMAX(4),						//138
		"я49.южорнв10 8.5", "    ", 	0,  65535,  12096, M_FACT|M_RMAX(4),						//139
		"я50.южорнв11 9  ", "    ", 	0,  65535,  12697, M_FACT|M_RMAX(4),						//140
		"я51.южорнв12 9.5", "    ", 	0,  65535,  13293, M_FACT|M_RMAX(4),						//141
		"я52.южорнв13 10 ", "    ", 	0,  65535,  13891, M_FACT|M_RMAX(4),						//142
		"я53.южорнв14 105", "    ", 	0,  65535,  14492, M_FACT|M_RMAX(4),						//143
		"я54.южорнв15 11 ", "    ", 	0,  65535,  15085, M_FACT|M_RMAX(4),						//144
		"я55.южорнв16 115", "    ", 	0,  65535,  15683, M_FACT|M_RMAX(4),						//145
                "я56.южорнв17 12 ", "    ", 	0,  65535,  16284, M_FACT|M_RMAX(4),						//146
                "я57.южорнв18 125", "    ", 	0,  65535,  16879, M_FACT|M_RMAX(4),						//147
                "я58.южорнв19 13 ", "    ", 	0,  65535,  17478, M_FACT|M_RMAX(4),						//148
                "я59.южорнв20 135", "    ", 	0,  65535,  18072, M_FACT|M_RMAX(4),						//149
                "я60.южорнв21 14 ", "    ", 	0,  65535,  18675, M_FACT|M_RMAX(4),						//150
                "я61.южорнв22 145", "    ", 	0,  65535,  19270, M_FACT|M_RMAX(4),						//151
		"я62.южорнв23 15 ", "    ", 	0,  65535,  19865, M_FACT|M_RMAX(4),						//152
                "я63.южорнв24 155", "    ", 	0,  65535,  20463, M_FACT|M_RMAX(4),						//153
		"я64.южорнв25 16 ", "    ", 	0,  65535,  21060, M_FACT|M_RMAX(4),						//154
		"я65.южорнв26 165", "    ", 	0,  65535,  21656, M_FACT|M_RMAX(4),						//155
                "я66.южорнв27 17 ", "    ", 	0,  65535,  22254, M_FACT|M_RMAX(4),						//156
		"я67.южорнв28 175", "    ", 	0,  65535,  22850, M_FACT|M_RMAX(4),						//157
		"я68.южорнв29 18 ", "    ", 	0,  65535,  23449, M_FACT|M_RMAX(4),						//158
		"я69.южорнв30 185", "    ", 	0,  65535,  24050, M_FACT|M_RMAX(4),						//159
		"я70.южорнв31 19 ", "    ", 	0,  65535,  24649, M_FACT|M_RMAX(4),						//160
		"я71.южорнв32 195", "    ", 	0,  65535,  25248, M_FACT|M_RMAX(4),						//161
		"я72.южорнв33 20 ", "    ", 	0,  65535,  25845, M_FACT|M_RMAX(4),						//162
		...
		"C134.оепец лндск", "    ",      0,      1,      1, M_FLST|M_SADR(154),					        //224 ЩРН
