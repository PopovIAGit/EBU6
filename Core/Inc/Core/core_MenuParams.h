...
const struct MENU_PARAM params[] = {
		...
		"B39.SAVE POS    ", "%   ", 	0,   1000,  	0, M_EDIT|M_RMAX(4),						//78
		...
		"   я39.пеб жюо  ", "    ", 	0,  1,  	0, M_FACT|M_RMAX(4),						//129
                "я40.южорнв1 4   ", "    ", 	0,  65535,   6716, M_FACT|M_RMAX(4),						//130
		"я41.южорнв2 4.5 ", "    ", 	0,  65535,   7315, M_FACT|M_RMAX(4),						//131
		"я42.южорнв3 5   ", "    ", 	0,  65535,   7914, M_FACT|M_RMAX(4),						//132
		"я43.южорнв4 5.5 ", "    ", 	0,  65535,   8509, M_FACT|M_RMAX(4),						//133
		"я44.южорнв5 6   ", "    ", 	0,  65535,   9107, M_FACT|M_RMAX(4),						//134
		...
		"я48.южорнв9 8   ", "    ", 	0,  65535,  11501, M_FACT|M_RMAX(4),						//138
		"я49.южорнв10 8.5", "    ", 	0,  65535,  12098, M_FACT|M_RMAX(4),						//139
		"я50.южорнв11 9  ", "    ", 	0,  65535,  12697, M_FACT|M_RMAX(4),						//140
		"я51.южорнв12 9.5", "    ", 	0,  65535,  13295, M_FACT|M_RMAX(4),						//141
		"я52.южорнв13 10 ", "    ", 	0,  65535,  13891, M_FACT|M_RMAX(4),						//142
		"я53.южорнв14 105", "    ", 	0,  65535,  14488, M_FACT|M_RMAX(4),						//143
		"я54.южорнв15 11 ", "    ", 	0,  65535,  15089, M_FACT|M_RMAX(4),						//144
		"я55.южорнв16 115", "    ", 	0,  65535,  15687, M_FACT|M_RMAX(4),						//145
                "я56.южорнв17 12 ", "    ", 	0,  65535,  16286, M_FACT|M_RMAX(4),						//146
                "я57.южорнв18 125", "    ", 	0,  65535,  16879, M_FACT|M_RMAX(4),						//147
                "я58.южорнв19 13 ", "    ", 	0,  65535,  17478, M_FACT|M_RMAX(4),						//148
                "я59.южорнв20 135", "    ", 	0,  65535,  18079, M_FACT|M_RMAX(4),						//149
                "я60.южорнв21 14 ", "    ", 	0,  65535,  18675, M_FACT|M_RMAX(4),						//150
                "я61.южорнв22 145", "    ", 	0,  65535,  19274, M_FACT|M_RMAX(4),						//151
		"я62.южорнв23 15 ", "    ", 	0,  65535,  19870, M_FACT|M_RMAX(4),						//152
                "я63.южорнв24 155", "    ", 	0,  65535,  20469, M_FACT|M_RMAX(4),						//153
		"я64.южорнв25 16 ", "    ", 	0,  65535,  21068, M_FACT|M_RMAX(4),						//154
		"я65.южорнв26 165", "    ", 	0,  65535,  21666, M_FACT|M_RMAX(4),						//155
                "я66.южорнв27 17 ", "    ", 	0,  65535,  22265, M_FACT|M_RMAX(4),						//156
		"я67.южорнв28 175", "    ", 	0,  65535,  22865, M_FACT|M_RMAX(4),						//157
		"я68.южорнв29 18 ", "    ", 	0,  65535,  23459, M_FACT|M_RMAX(4),						//158
		"я69.южорнв30 185", "    ", 	0,  65535,  24060, M_FACT|M_RMAX(4),						//159
		"я70.южорнв31 19 ", "    ", 	0,  65535,  24657, M_FACT|M_RMAX(4),						//160
		"я71.южорнв32 195", "    ", 	0,  65535,  25254, M_FACT|M_RMAX(4),						//161
		"я72.южорнв33 20 ", "    ", 	0,  65535,  25850, M_FACT|M_RMAX(4),						//162
