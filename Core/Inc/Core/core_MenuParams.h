...
const struct MENU_PARAM params[] = {
		...
		"B28.бпел пюгцнмю", "    ", 	0,    100,    100, M_EDIT|M_RMAX(2)|M_PREC(1),							//68
		"B29.яйнп люйя   ", "цж  ", 	0,    500,    500, M_EDIT|M_RMAX(2)|M_PREC(1),							//69
		"B30.бпел рнплнф ", "    ", 	0,    100,    100, M_EDIT|M_RMAX(2)|M_PREC(1),							//70
		...
		"я29.оняр.бп.RMS ", "MйC ",     0,    100,      1, M_FACT|M_RMAX(2)|M_PREC(1),				        //119
                "я30.нрйк рщм    ", "    ",    10,     60,     40, M_FACT|M_RMAX(2),					        //120
		...
		"   я38.RESERV   ", "    ", 	0,  65535,  	0, M_SHOW|M_RMAX(4),						//128
		"   я39.RESERV   ", "    ", 	0,  65535,  	0, M_SHOW|M_RMAX(4),						//129
                "   я40.южорнв1  ", "    ", 	0,  65535,   6800, M_SHOW|M_RMAX(4),						//130
		"   я41.южорнв2  ", "    ", 	0,  65535,   7400, M_SHOW|M_RMAX(4),						//131
		"   я42.южорнв3  ", "    ", 	0,  65535,   8000, M_SHOW|M_RMAX(4),						//132
		"   я43.южорнв4  ", "    ", 	0,  65535,   8600, M_SHOW|M_RMAX(4),						//133
		"   я44.южорнв5  ", "    ", 	0,  65535,   9200, M_SHOW|M_RMAX(4),						//134
		"   я45.южорнв6  ", "    ", 	0,  65535,   9800, M_SHOW|M_RMAX(4),						//135
                "   я46.южорнв7  ", "    ", 	0,  65535,  10400, M_SHOW|M_RMAX(4),						//136
		"   я47.южорнв8  ", "    ", 	0,  65535,  11000, M_SHOW|M_RMAX(4),						//137
		"   я48.южорнв9  ", "    ", 	0,  65535,  11590, M_SHOW|M_RMAX(4),						//138
		"   я49.южорнв10 ", "    ", 	0,  65535,  12190, M_SHOW|M_RMAX(4),						//139
		"   я50.южорнв11 ", "    ", 	0,  65535,  12790, M_SHOW|M_RMAX(4),						//140
		"   я51.южорнв12 ", "    ", 	0,  65535,  13390, M_SHOW|M_RMAX(4),						//141
		"   я52.южорнв13 ", "    ", 	0,  65535,  13980, M_SHOW|M_RMAX(4),						//142
		"   я53.южорнв14 ", "    ", 	0,  65535,  14580, M_SHOW|M_RMAX(4),						//143
		"   я54.южорнв15 ", "    ", 	0,  65535,  15170, M_SHOW|M_RMAX(4),						//144
		"   я55.южорнв16 ", "    ", 	0,  65535,  15780, M_SHOW|M_RMAX(4),						//145
                "   я56.южорнв17 ", "    ", 	0,  65535,  16370, M_SHOW|M_RMAX(4),						//146
                "   я57.южорнв18 ", "    ", 	0,  65535,  16970, M_SHOW|M_RMAX(4),						//147
                "   я58.южорнв19 ", "    ", 	0,  65535,  17560, M_SHOW|M_RMAX(4),						//148
                "   я59.южорнв20 ", "    ", 	0,  65535,  18170, M_SHOW|M_RMAX(4),						//149
                "   я60.южорнв21 ", "    ", 	0,  65535,  18760, M_SHOW|M_RMAX(4),						//150
                "   я61.южорнв22 ", "    ", 	0,  65535,  19360, M_SHOW|M_RMAX(4),						//151
		"   я62.южорнв23 ", "    ", 	0,  65535,  19960, M_SHOW|M_RMAX(4),						//152
                "   я63.южорнв24 ", "    ", 	0,  65535,  20560, M_SHOW|M_RMAX(4),						//153
		"   я64.южорнв25 ", "    ", 	0,  65535,  21150, M_SHOW|M_RMAX(4),						//154
		"   я65.южорнв26 ", "    ", 	0,  65535,  21750, M_SHOW|M_RMAX(4),						//155
                "   я66.южорнв27 ", "    ", 	0,  65535,  22350, M_SHOW|M_RMAX(4),						//156
		"   я67.южорнв28 ", "    ", 	0,  65535,  22950, M_SHOW|M_RMAX(4),						//157
		"   я68.южорнв29 ", "    ", 	0,  65535,  23550, M_SHOW|M_RMAX(4),						//158
		"   я69.южорнв30 ", "    ", 	0,  65535,  24145, M_SHOW|M_RMAX(4),						//159
		"   я70.южорнв31 ", "    ", 	0,  65535,  24750, M_SHOW|M_RMAX(4),						//160
		"   я71.южорнв32 ", "    ", 	0,  65535,  25340, M_SHOW|M_RMAX(4),						//161
		"   я72.южорнв33 ", "    ", 	0,  65535,  25940, M_SHOW|M_RMAX(4),						//162
		"   я73.жюпрнв1  ", "    ", 	0,  65535,   6410, M_SHOW|M_RMAX(4),						//163
                "   я74.жюпрнв2  ", "    ", 	0,  65535,   7218, M_SHOW|M_RMAX(4),						//164
		"   я75.жюпрнв3  ", "    ", 	0,  65535,   8020, M_SHOW|M_RMAX(4),						//165
                "   я76.жюпрнв4  ", "    ", 	0,  65535,   8820, M_SHOW|M_RMAX(4),						//166
                "   я77.жюпрнв5  ", "    ", 	0,  65535,   9620, M_SHOW|M_RMAX(4),						//167
                "   я78.жюпрнв6  ", "    ", 	0,  65535,  10420, M_SHOW|M_RMAX(4),						//168
                "   я79.жюпрнв7  ", "    ", 	0,  65535,  11220, M_SHOW|M_RMAX(4),						//169
                "   я80.жюпрнв8  ", "    ", 	0,  65535,  12020, M_SHOW|M_RMAX(4),						//170
                "   я81.жюпрнв9  ", "    ", 	0,  65535,  12820, M_SHOW|M_RMAX(4),						//171
		"   я82.жюпрнв10 ", "    ", 	0,  65535,  13620, M_SHOW|M_RMAX(4),						//172
		"   я83.жюпрнв11 ", "    ", 	0,  65535,  14420, M_SHOW|M_RMAX(4),						//173
		"   я84.жюпрнв12 ", "    ", 	0,  65535,  15220, M_SHOW|M_RMAX(4),						//174
		"   я85.жюпрнв13 ", "    ", 	0,  65535,  16030, M_SHOW|M_RMAX(4),						//175
                "   я86.жюпрнв14 ", "    ", 	0,  65535,  16830, M_SHOW|M_RMAX(4),						//176
		"   я87.жюпрнв15 ", "    ", 	0,  65535,  17630, M_SHOW|M_RMAX(4),						//177
		"   я88.жюпрнв16 ", "    ", 	0,  65535,  18430, M_SHOW|M_RMAX(4),						//178
		"   я89.жюпрнв17 ", "    ", 	0,  65535,  19230, M_SHOW|M_RMAX(4),						//179
		"   я90.жюпрнв18 ", "    ", 	0,  65535,  20040, M_SHOW|M_RMAX(4),						//180
		"   я91.жюпрнв19 ", "    ", 	0,  65535,  20840, M_SHOW|M_RMAX(4),						//181
		"   я92.жюпрнв20 ", "    ", 	0,  65535,  21640, M_SHOW|M_RMAX(4),						//182
		"   я93.жюпрнв21 ", "    ", 	0,  65535,  22440, M_SHOW|M_RMAX(4),						//183
		"   я94.жюпрнв22 ", "    ", 	0,  65535,  23240, M_SHOW|M_RMAX(4),						//184
		"   я95.жюпрнв23 ", "    ", 	0,  65535,  24040, M_SHOW|M_RMAX(4),						//185
                "   я96.жюпрнв24 ", "    ", 	0,  65535,  24840, M_SHOW|M_RMAX(4),						//186
                "   я97.жюпрнв25 ", "    ", 	0,  65535,  25640, M_SHOW|M_RMAX(4),						//187
                "   я98.жюпрнв26 ", "    ", 	0,  65535,  26440, M_SHOW|M_RMAX(4),						//188
                "   я99.жюпрнв27 ", "    ", 	0,  65535,  27250, M_SHOW|M_RMAX(4),						//189
                "   я100.жюпрнв28", "    ", 	0,  65535,  28050, M_SHOW|M_RMAX(4),						//190
                "   я101.жюпрнв29", "    ", 	0,  65535,  28850, M_SHOW|M_RMAX(4),						//191
		"   я102.жюпрнв30", "    ", 	0,  65535,  29650, M_SHOW|M_RMAX(4),						//192
		"   я103.жюпрнв31", "    ", 	0,  65535,  30450, M_SHOW|M_RMAX(4),						//193
		"   я104.жюпрнв32", "    ", 	0,  65535,  31250, M_SHOW|M_RMAX(4),						//194
		"   я105.жюпрнв33", "    ", 	0,  65535,  32060, M_SHOW|M_RMAX(4),						//195
		...
		"   я110.RESERV  ", "    ", 	0,  65535,  	0, M_SHOW|M_RMAX(4),						//200
		"   я111.RESERV  ", "    ", 	0,  65535,  	0, M_SHOW|M_RMAX(4),						//201
		"   я112.RESERV  ", "    ", 	0,  65535,  	0, M_SHOW|M_RMAX(4),						//202
		"   я113.RESERV  ", "    ", 	0,  65535,  	0, M_SHOW|M_RMAX(4),						//203
		"   я114.RESERV  ", "    ", 	0,  65535,  	0, M_SHOW|M_RMAX(4),						//204
		"   я115.RESERV  ", "    ", 	0,  65535,  	0, M_SHOW|M_RMAX(4),						//205
                "   я116.RESERV  ", "    ", 	0,  65535,  	0, M_SHOW|M_RMAX(4),						//206
                "   я117.RESERV  ", "    ", 	0,  65535,  	0, M_SHOW|M_RMAX(4),						//207
                "   я118.RESERV  ", "    ", 	0,  65535,  	0, M_SHOW|M_RMAX(4),						//208
                "   я119.RESERV  ", "    ", 	0,  65535,  	0, M_SHOW|M_RMAX(4),						//209
                "   я120.RESERV  ", "    ", 	0,  65535,  	0, M_SHOW|M_RMAX(4),						//210
                "   я121.RESERV  ", "    ", 	0,  65535,  	0, M_SHOW|M_RMAX(4),						//211
		"   я122.RESERV  ", "    ", 	0,  65535,  	0, M_SHOW|M_RMAX(4),						//212
		"   я123.RESERV  ", "    ", 	0,  65535,  	0, M_SHOW|M_RMAX(4),						//213
		"   я124.RESERV  ", "    ", 	0,  65535,  	0, M_SHOW|M_RMAX(4),						//214
		"   я125.RESERV  ", "    ", 	0,  65535,  	0, M_SHOW|M_RMAX(4),						//215
                "   я126.RESERV  ", "    ", 	0,  65535,  	0, M_SHOW|M_RMAX(4),						//216
		"   я127.RESERV  ", "    ", 	0,  65535,  	0, M_SHOW|M_RMAX(4),						//217
		"   я128.RESERV  ", "    ", 	0,  65535,  	0, M_SHOW|M_RMAX(4),						//218
		"   я129.RESERV  ", "    ", 	0,  65535,  	0, M_SHOW|M_RMAX(4),						//219
		"   я130.RESERV  ", "    ", 	0,  65535,  	0, M_SHOW|M_RMAX(4),						//220
		"   я131.RESERV  ", "    ", 	0,  65535,  	0, M_SHOW|M_RMAX(4),						//221
		"   я132.RESERV  ", "    ", 	0,  65535,  	0, M_SHOW|M_RMAX(4),						//222
		"   я133.RESERV  ", "    ", 	0,  65535,  	0, M_SHOW|M_RMAX(4),						//223
		"   я134.RESERV  ", "    ", 	0,  65535,  	0, M_SHOW|M_RMAX(4),						//224
		"   я135.RESERV  ", "    ", 	0,  65535,  	0, M_SHOW|M_RMAX(4),						//225
                "   я136.RESERV  ", "    ", 	0,  65535,  	0, M_SHOW|M_RMAX(4),						//226
		...
		"   я195.RESERV  ", "    ", 	0,  65535,  	0, M_SHOW|M_RMAX(4),						//285
                ...
                //------------------------------------------------------------------
		"D0.SET CLOSE    ", "    ",      0,      2,      0, M_COMM|M_SADR(155),						//0 290
		"D1.SET OPEN     ", "    ",      0,      2,      0, M_COMM|M_SADR(155),						//1 291
		...
		"D5.CALIB RESET  ", "    ",      0,      1,      0, M_COMM|M_SADR(158),						//5 295
		"D6.COMANDS      ", "    ",      0,     19,      0, M_COMM|M_SADR(160),						//6 296
		" D7.ERR RESET   ", "    ",      0,      1,      0, M_COMM|M_SADR(160),						//7 297
		" D8.SET DEFOULT ", "    ",      0,      1,      0, M_COMM|M_SADR(155),						//8 298
		"   D9.RESERV    ", "    ",      0,  65535,  	0, M_SHOW|M_SADR(4),						//9 299
		"D10.CYCLE RESET ", "    ",      0,      1,     0, M_COMM|M_SADR(160),						//10 300
		"D11.COMM RESET  ", "    ", 	 0,  	 1,  	0, M_COMM|M_SADR(160),						//11 301
