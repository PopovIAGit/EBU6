...
const struct MENU_PARAM params[] = {
		...
		"C11.HALL STATE  ", "    ",     0,  65535,      0, M_SHOW|M_RMAX(4),                                            //101
                " я38.йнп рнйю U ", "    ",     0,  65530,   4000, M_FACT|M_RMAX(4),						//102
		" я39.йнп рнйю V ", "    ",     0,  65530,   4000, M_FACT|M_RMAX(4),						//103
		" я40.йнп рнйю W ", "    ",     0,  65530,   4000, M_FACT|M_RMAX(4),						//104
		"я41.ялеы рнйю U ", "    ",     0,  65530,  32690, M_FACT|M_RMAX(4),						//105
		"я42.ялеы рнйю V ", "    ",     0,  65530,  32690, M_FACT|M_RMAX(4),						//106
		"я43.ялеы рнйю W ", "    ",     0,  65530,  32690, M_FACT|M_RMAX(4),						//107
		" я44.йнп мюоп R ", "    ",     0,  65530,   2000, M_FACT|M_RMAX(4),						//108
		" я45.йнп мюоп S ", "    ",     0,  65530,   2000, M_FACT|M_RMAX(4),						//109
		" я46.йнп мюоп T ", "    ",     0,  65530,   2000, M_FACT|M_RMAX(4),						//110
                "я47.ялеы мюоп R ", "    ",     0,  65530,  32760, M_FACT|M_RMAX(4),						//111
		"я48.ялеы мюоп S ", "    ",     0,  65530,  32760, M_FACT|M_RMAX(4),						//112
		"я49.ялеы мюоп T ", "    ",     0,  65530,  32760, M_FACT|M_RMAX(4),						//113
                " я50.йнп мюо VDC", "    ",     0,  65530,   1240, M_FACT|M_RMAX(4),						//114
                "я51.ялеы мюо VDC", "    ",     0,  65530,      0, M_FACT|M_RMAX(4),						//115
                " я52.йнп рнйю BR", "    ",     0,  65530,   1240, M_FACT|M_RMAX(4),						//116
                "я53.ялеы рнйю BR", "    ",     0,  65530,      0, M_FACT|M_RMAX(4),						//117 
                "я54.оняр.бп.яхм ", "MйC ",     0,    100,     21, M_FACT|M_RMAX(2)|M_PREC(1),				        //118
		"я55.оняр.бп.RMS ", "MйC ",     0,    100,      1, M_FACT|M_RMAX(2)|M_PREC(1),				        //119
                "я34.нрйк рщм    ", "    ",    10,     60,     40, M_FACT|M_RMAX(2),					        //120
		"я35.бшанп лным  ", "    ", 	0,      1,  	1, M_FACT|M_SADR(124),						//121
		"я36.лнд охрюмхъ ", "    ", 	0,      1,  	1, M_FACT|M_SADR(257),						//122
		"   B37.RESERV   ", "    ", 	0,  65535,  	0, M_SHOW|M_RMAX(4),						//123
		"   B38.RESERV   ", "    ", 	0,  65535,  	0, M_SHOW|M_RMAX(4),						//124
		"   B39.RESERV   ", "    ", 	0,  65535,  	0, M_SHOW|M_RMAX(4),						//125
		"   B40.RESERV   ", "    ", 	0,  65535,  	0, M_SHOW|M_RMAX(4),						//126
		"   B41.RESERV   ", "    ", 	0,  65535,  	0, M_SHOW|M_RMAX(4),						//127
		"   B42.RESERV   ", "    ", 	0,  65535,  	0, M_SHOW|M_RMAX(4),						//128
		"   B43.RESERV   ", "    ", 	0,  65535,  	0, M_SHOW|M_RMAX(4),						//129
		"   B44.RESERV   ", "    ", 	0,  65535,  	0, M_SHOW|M_RMAX(4),						//130
		"   B45.RESERV   ", "    ", 	0,  65535,  	0, M_SHOW|M_RMAX(4),						//131
		"   B46.RESERV   ", "    ", 	0,  65535,  	0, M_SHOW|M_RMAX(4),						//132
		"   B47.RESERV   ", "    ", 	0,  65535,  	0, M_SHOW|M_RMAX(4),						//133
		"   B48.RESERV   ", "    ", 	0,  65535,  	0, M_SHOW|M_RMAX(4),						//134
		"   B49.RESERV   ", "    ", 	0,  65535,  	0, M_SHOW|M_RMAX(4),						//135
                "   B34.RESERV   ", "    ", 	0,  65535,  	0, M_SHOW|M_RMAX(4),						//136
		"   B35.RESERV   ", "    ", 	0,  65535,  	0, M_SHOW|M_RMAX(4),						//137
		"   B36.RESERV   ", "    ", 	0,  65535,  	0, M_SHOW|M_RMAX(4),						//138
		"   B37.RESERV   ", "    ", 	0,  65535,  	0, M_SHOW|M_RMAX(4),						//139
		"   B38.RESERV   ", "    ", 	0,  65535,  	0, M_SHOW|M_RMAX(4),						//140
		"   B39.RESERV   ", "    ", 	0,  65535,  	0, M_SHOW|M_RMAX(4),						//141
		"   B40.RESERV   ", "    ", 	0,  65535,  	0, M_SHOW|M_RMAX(4),						//142
		"   B41.RESERV   ", "    ", 	0,  65535,  	0, M_SHOW|M_RMAX(4),						//143
		"   B42.RESERV   ", "    ", 	0,  65535,  	0, M_SHOW|M_RMAX(4),						//144
		"   B43.RESERV   ", "    ", 	0,  65535,  	0, M_SHOW|M_RMAX(4),						//145
		"   B44.RESERV   ", "    ", 	0,  65535,  	0, M_SHOW|M_RMAX(4),						//146
		"   B45.RESERV   ", "    ", 	0,  65535,  	0, M_SHOW|M_RMAX(4),						//147
		"   B46.RESERV   ", "    ", 	0,  65535,  	0, M_SHOW|M_RMAX(4),						//148
		"   B47.RESERV   ", "    ", 	0,  65535,  	0, M_SHOW|M_RMAX(4),						//149
		"   B48.RESERV   ", "    ", 	0,  65535,  	0, M_SHOW|M_RMAX(4),						//150
		"   B49.RESERV   ", "    ", 	0,  65535,  	0, M_SHOW|M_RMAX(4),						//151
                "   B34.RESERV   ", "    ", 	0,  65535,  	0, M_SHOW|M_RMAX(4),						//152
		"   B35.RESERV   ", "    ", 	0,  65535,  	0, M_SHOW|M_RMAX(4),						//153
		"   B36.RESERV   ", "    ", 	0,  65535,  	0, M_SHOW|M_RMAX(4),						//154
		"   B37.RESERV   ", "    ", 	0,  65535,  	0, M_SHOW|M_RMAX(4),						//155
		"   B38.RESERV   ", "    ", 	0,  65535,  	0, M_SHOW|M_RMAX(4),						//156
		"   B39.RESERV   ", "    ", 	0,  65535,  	0, M_SHOW|M_RMAX(4),						//157
		"   B40.RESERV   ", "    ", 	0,  65535,  	0, M_SHOW|M_RMAX(4),						//158
		"   B41.RESERV   ", "    ", 	0,  65535,  	0, M_SHOW|M_RMAX(4),						//159
                //------------------------------------------------------------------
